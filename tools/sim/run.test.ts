...
describe('run.ts N validation (F20)', () => {
  ...
  it('does NOT throw for N=3 (the documented floor) and prints the board', async () => {
    ...
    for (const name of [
      'SRD Berserker — greatsword',
      'SRD Berserker — thrown handaxes',
      'SRD Champion — greatsword',
      'SRD Champion — shortbow',
      'SRD Open Hand — unarmed',
      'SRD Open Hand — thrown handaxe',
      'SRD Thief — swords',
      'SRD Thief — shortbow',
      'SRD Devotion — melee',
      'SRD Devotion — thrown javelins',
      'SRD Hunter — TWF melee',
      'SRD Hunter — longbow',
      'SRD Life — ranged spell posture',
      'SRD Land (Arid) — ranged spells',
    ...
    expect(allOutput).toContain('SRD Lore — caster posture †');
