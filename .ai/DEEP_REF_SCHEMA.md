...
Derived from the classification: `SnapshotTable` (`:891`), `BackupTable` (`:893`),
`ShareTable` (`:894`), and the ordered constants `CHARACTER_STATE_TABLES`
(`:1051`), `DELETE_ORDER` (`:1094`), `BACKUP_TABLES` (`:1150`), `SHARE_TABLES`
(`:1229`).
