...
Derived from the classification: `SnapshotTable` (`:1117`), `BackupTable` (`:1119`),
`ShareTable` (`:1120`), and the ordered constants `CHARACTER_STATE_TABLES`
(`:1319`), `DELETE_ORDER` (`:1404`), `BACKUP_TABLES` (`:1471`), `SHARE_TABLES`
(`:1564`).
