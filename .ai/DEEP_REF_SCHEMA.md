...
| `rows.ts` | The Zod contracts. `COLUMN_REFINEMENTS` (`:385`), `NARROWED_REFINEMENTS` (`:460`), `rowContractError` (`:1381`) |
...
path in `src/character/character-state.ts`: `CHARACTER_STATE_COLUMNS` (`:351`) for
