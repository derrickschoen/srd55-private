...
| `rows.ts` | The Zod contracts. `COLUMN_REFINEMENTS` (`:360`), `NARROWED_REFINEMENTS` (`:426`), `rowContractError` (`:1291`) |
...
path in `src/character/character-state.ts`: `CHARACTER_STATE_COLUMNS` (`:318`) for
