...
export const CHARACTER_BACKUP_VERSION = 8 as const;
export const PRE_OPTIONAL_FEATURE_SELECTION_CHARACTER_BACKUP_VERSION = 7 as const;
export const PRE_PROVENANCE_CHARACTER_BACKUP_VERSION = 6 as const;
