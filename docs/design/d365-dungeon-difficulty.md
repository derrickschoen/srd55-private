...
against four ordinary PC turns. It is a structural ratio, not an XP-budget
...
|---|---|---:|---:|---|
| Briar Gate Pack | 2 Goblin Warriors, 2 Wolves | 4 / 4 | **1.0x** | Blocked center cell; Pack Tactics and distributed targets. |
| Webbed Bear Den | Cave Bear, Ambush Weaver | 2 / 4 | **0.5x** | Two blocked cells; grapple/squeeze, Web, venom, Spider Climb. |
| Ridgewing Gallery | Scout, Ridgewing Hunter, Storm Raptor | 3 / 4 | **0.75x** | Two blocked cells; ranged fire, flight, charge/raking pass, Prone riders. |
| Ironweb Crown | Ironweb Weaver | 1 / 4 | **0.25x** | Two blocked cells; Web/Restrained control, venom, Spider Climb. |

The D382 detune removed one Scout from Ridgewing Gallery (1.0x to 0.75x) and
replaced the former Dreadweb Weaver plus two Bugbear Stalkers (3 / 4, 0.75x)
with one Ironweb Weaver (1 / 4, 0.25x). The leader/control identity remains a
