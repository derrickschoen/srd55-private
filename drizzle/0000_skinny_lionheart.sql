...
CREATE UNIQUE INDEX `class_definitions_content_key_unique` ON `class_definitions` (`content_key`);--> statement-breakpoint
CREATE UNIQUE INDEX `class_definitions_name_rules_edition_unique` ON `class_definitions` (`name`,`rules_edition`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `class_progressions_class_definition_id_class_level_unique` ON `class_progressions` (`class_definition_id`,`class_level`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `named_features_content_key_unique` ON `named_features` (`content_key`);--> statement-breakpoint
CREATE UNIQUE INDEX `named_features_class_name_rules_edition_unique` ON `named_features` (`class_definition_id`,`name`,`rules_edition`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `subclass_definitions_content_key_unique` ON `subclass_definitions` (`content_key`);--> statement-breakpoint
CREATE UNIQUE INDEX `subclass_definitions_class_definition_id_name_rules_edition_unique` ON `subclass_definitions` (`class_definition_id`,`name`,`rules_edition`);--> statement-breakpoint
CREATE UNIQUE INDEX `subclass_definitions_id_class_definition_id_unique` ON `subclass_definitions` (`id`,`class_definition_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `subclass_features_subclass_sort_unique` ON `subclass_features` (`subclass_definition_id`,`sort_order`);--> statement-breakpoint
CREATE UNIQUE INDEX `subclass_features_subclass_name_unique` ON `subclass_features` (`subclass_definition_id`,`name`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `subclass_progressions_subclass_definition_id_class_level_unique` ON `subclass_progressions` (`subclass_definition_id`,`class_level`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `background_definitions_content_key_unique` ON `background_definitions` (`content_key`);--> statement-breakpoint
CREATE UNIQUE INDEX `background_definitions_name_rules_edition_unique` ON `background_definitions` (`name`,`rules_edition`);--> statement-breakpoint
...
CREATE UNIQUE INDEX `feat_definitions_name_rules_edition_unique` ON `feat_definitions` (`name`,`rules_edition`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `species_definitions_content_key_unique` ON `species_definitions` (`content_key`);--> statement-breakpoint
CREATE UNIQUE INDEX `species_definitions_name_rules_edition_unique` ON `species_definitions` (`name`,`rules_edition`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `spell_identities_content_key_unique` ON `spell_identities` (`content_key`);--> statement-breakpoint
CREATE INDEX `spell_identities_normalized_name_index` ON `spell_identities` (`normalized_name`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `spell_identity_aliases_normalized_alias_unique` ON `spell_identity_aliases` (`normalized_alias`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `spell_list_memberships_spell_version_id_spell_list_key_unique` ON `spell_list_memberships` (`spell_version_id`,`spell_list_key`);--> statement-breakpoint
CREATE INDEX `spell_list_memberships_spell_list_key_index` ON `spell_list_memberships` (`spell_list_key`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `spell_version_attack_modes_spell_version_id_attack_mode_unique` ON `spell_version_attack_modes` (`spell_version_id`,`attack_mode`);--> statement-breakpoint
CREATE INDEX `spell_version_attack_modes_attack_mode_index` ON `spell_version_attack_modes` (`attack_mode`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `spell_version_cantrip_upgrade_levels_spell_version_id_level_unique` ON `spell_version_cantrip_upgrade_levels` (`spell_version_id`,`level`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `spell_version_conditions_spell_version_id_condition_type_unique` ON `spell_version_conditions` (`spell_version_id`,`condition_type`);--> statement-breakpoint
CREATE INDEX `spell_version_conditions_condition_type_index` ON `spell_version_conditions` (`condition_type`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `spell_version_damage_types_spell_version_id_damage_type_unique` ON `spell_version_damage_types` (`spell_version_id`,`damage_type`);--> statement-breakpoint
CREATE INDEX `spell_version_damage_types_damage_type_index` ON `spell_version_damage_types` (`damage_type`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `spell_version_publications_spell_version_id_source_book_unique` ON `spell_version_publications` (`spell_version_id`,`source_book`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `spell_version_save_abilities_spell_version_id_save_ability_unique` ON `spell_version_save_abilities` (`spell_version_id`,`save_ability`);--> statement-breakpoint
CREATE INDEX `spell_version_save_abilities_save_ability_index` ON `spell_version_save_abilities` (`save_ability`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `spell_version_tags_spell_version_id_tag_unique` ON `spell_version_tags` (`spell_version_id`,`tag`);--> statement-breakpoint
CREATE INDEX `spell_version_tags_tag_index` ON `spell_version_tags` (`tag`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `spell_version_upcast_levels_spell_version_id_level_unique` ON `spell_version_upcast_levels` (`spell_version_id`,`level`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `spell_versions_content_key_unique` ON `spell_versions` (`content_key`);--> statement-breakpoint
CREATE UNIQUE INDEX `spell_versions_spell_identity_id_rules_edition_unique` ON `spell_versions` (`spell_identity_id`,`rules_edition`);--> statement-breakpoint
CREATE INDEX `spell_versions_rules_edition_level_index` ON `spell_versions` (`rules_edition`,`level`);--> statement-breakpoint
CREATE INDEX `spell_versions_is_active_index` ON `spell_versions` (`is_active`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `change_log_character_id_sequence_unique` ON `change_log` (`character_id`,`sequence`);--> statement-breakpoint
CREATE INDEX `change_log_character_id_group_id_index` ON `change_log` (`character_id`,`group_id`);--> statement-breakpoint
CREATE INDEX `change_log_operation_uuid_index` ON `change_log` (`operation_uuid`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `character_class_levels_character_id_class_definition_id_unique` ON `character_class_levels` (`character_id`,`class_definition_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `character_operations_operation_uuid_unique` ON `character_operations` (`operation_uuid`);--> statement-breakpoint
CREATE INDEX `character_operations_character_id_resulting_revision_index` ON `character_operations` (`character_id`,`resulting_revision`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `character_rule_overrides_character_id_rule_key_unique` ON `character_rule_overrides` (`character_id`,`rule_key`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `character_source_instances_instance_uuid_unique` ON `character_source_instances` (`instance_uuid`);--> statement-breakpoint
CREATE INDEX `character_source_instances_character_id_state_index` ON `character_source_instances` (`character_id`,`state`);--> statement-breakpoint
CREATE UNIQUE INDEX `character_source_instances_id_character_id_unique` ON `character_source_instances` (`id`,`character_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `character_spell_preferences_character_id_spell_version_id_unique` ON `character_spell_preferences` (`character_id`,`spell_version_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `spell_loadout_entries_spell_loadout_id_spell_version_id_role_unique` ON `spell_loadout_entries` (`spell_loadout_id`,`spell_version_id`,`role`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `spell_selection_slots_character_id_slot_key_unique` ON `spell_selection_slots` (`character_id`,`slot_key`);--> statement-breakpoint
CREATE INDEX `spell_selection_slots_character_id_state_index` ON `spell_selection_slots` (`character_id`,`state`);--> statement-breakpoint
CREATE INDEX `spell_selection_slots_character_id_bucket_index` ON `spell_selection_slots` (`character_id`,`bucket`);--> statement-breakpoint
CREATE INDEX `slots_character_collection_index` ON `spell_selection_slots` (`character_id`,`selection_collection`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `warning_acknowledgements_character_id_warning_fingerprint_unique` ON `warning_acknowledgements` (`character_id`,`warning_fingerprint`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `wizard_spellbook_entries_character_id_spell_version_id_unique` ON `wizard_spellbook_entries` (`character_id`,`spell_version_id`);--> statement-breakpoint
...
CREATE INDEX `background_equipment_items_background_template_id_index` ON `background_equipment_items` (`background_template_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `background_templates_content_key_unique` ON `background_templates` (`content_key`);--> statement-breakpoint
CREATE UNIQUE INDEX `background_templates_name_rules_edition_unique` ON `background_templates` (`name`,`rules_edition`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `character_background_character_id_unique` ON `character_background` (`character_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `character_species_character_id_unique` ON `character_species` (`character_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `character_species_traits_character_id_index` ON `character_species_traits` (`character_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `species_template_traits_template_sort_unique` ON `species_template_traits` (`species_template_id`,`sort_order`);--> statement-breakpoint
CREATE UNIQUE INDEX `species_template_traits_template_name_unique` ON `species_template_traits` (`species_template_id`,`name`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `species_templates_content_key_unique` ON `species_templates` (`content_key`);--> statement-breakpoint
CREATE UNIQUE INDEX `species_templates_name_rules_edition_unique` ON `species_templates` (`name`,`rules_edition`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `armor_templates_content_key_unique` ON `armor_templates` (`content_key`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `class_armor_training_class_definition_id_category_unique` ON `class_armor_training` (`class_definition_id`,`category`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `class_extra_attack_grants_class_definition_id_class_level_unique` ON `class_extra_attack_grants` (`class_definition_id`,`class_level`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `class_martial_arts_dice_class_definition_id_class_level_unique` ON `class_martial_arts_dice` (`class_definition_id`,`class_level`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `class_saving_throw_proficiencies_class_definition_id_ability_unique` ON `class_saving_throw_proficiencies` (`class_definition_id`,`ability`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `class_sheet_traits_class_definition_id_unique` ON `class_sheet_traits` (`class_definition_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `class_skill_options_class_definition_id_skill_unique` ON `class_skill_options` (`class_definition_id`,`skill`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `class_weapon_proficiencies_class_definition_id_category_unique` ON `class_weapon_proficiencies` (`class_definition_id`,`category`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `character_hit_point_rolls_character_id_class_name_class_level_unique` ON `character_hit_point_rolls` (`character_id`,`class_name`,`class_level`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `character_sheet_adjustments_character_id_unique` ON `character_sheet_adjustments` (`character_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `character_skill_proficiencies_character_id_skill_unique` ON `character_skill_proficiencies` (`character_id`,`skill`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `class_weapon_mastery_counts_class_definition_id_class_level_unique` ON `class_weapon_mastery_counts` (`class_definition_id`,`class_level`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `class_weapon_mastery_grants_class_definition_id_unique` ON `class_weapon_mastery_grants` (`class_definition_id`);--> statement-breakpoint
