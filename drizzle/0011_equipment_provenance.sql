...
INSERT INTO `__new_character_weapons`(
  "id", "character_id", "source_instance_id", "name", "proficiency_category", "attack_kind", "damage_kind", "damage_dice", "damage_flat", "damage_custom", "damage_type", "versatile_damage_kind", "versatile_damage_dice", "versatile_damage_flat", "versatile_damage_custom", "finesse", "heavy", "light", "loading", "reach", "thrown", "two_handed", "ammunition", "ammunition_kind", "range_kind", "range_near_feet", "range_far_feet", "mastery_property", "mastery_selected", "other_properties", "notes", "created_at", "updated_at"
)
SELECT
  "id", "character_id", NULL, "name", "proficiency_category", "attack_kind", "damage_kind", "damage_dice", "damage_flat", "damage_custom", "damage_type", "versatile_damage_kind", "versatile_damage_dice", "versatile_damage_flat", "versatile_damage_custom", "finesse", "heavy", "light", "loading", "reach", "thrown", "two_handed", "ammunition", "ammunition_kind", "range_kind", "range_near_feet", "range_far_feet", "mastery_property", "mastery_selected", "other_properties", "notes", "created_at", "updated_at"
...
INSERT INTO `__new_character_armor`(
  "id", "character_id", "source_instance_id", "slot", "name", "category", "armor_class", "dex_bonus", "dex_bonus_max", "strength_requirement", "stealth_disadvantage", "notes", "created_at", "updated_at"
)
SELECT
  "id", "character_id", NULL, "slot", "name", "category", "armor_class", "dex_bonus", "dex_bonus_max", "strength_requirement", "stealth_disadvantage", "notes", "created_at", "updated_at"
