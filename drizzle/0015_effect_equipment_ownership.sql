...
CREATE UNIQUE INDEX `character_weapons_id_character_id_unique`
  ON `character_weapons` (`id`,`character_id`);
...
SELECT
  ...
  hit_points_per_level, speed_bonus_feet, ability, amount, maximum, base,
  ability_1, ability_2, allows_shield, weapon_scope, source_instance_id,
  NULL, NULL, template_ref, label, notes, created_at, updated_at
