...
### Generated art (CC0-1.0)

The fixed-input pixel silhouettes, room tiles, terrain, fog, active-PC focus,
and `ADJUDICATED` styling generated by the repository are project-original
art. Every generated asset under `public/assets/art/`, every output of
`tools/assets/generate-starter-art.ts` and `src/assets/pixel-art.ts`, and the
repository's generated board glyphs, badges, and pixel-font renders are
dedicated to the public domain under CC0 1.0 Universal. The verbatim dedication
is [LICENSE-ART](LICENSE-ART), and the clean-room generation statement is
[ART-PROVENANCE.md](ART-PROVENANCE.md). Generator software and TypeScript
inputs remain MIT-licensed.
...
software only; generated art uses CC0, while the SRD 5.2.1 material and the
CC-BY-4.0 documents listed in this file keep their own license and attribution
requirements. All three sets of terms travel with a redistribution.
