...
const LEVEL_FOUR_PINS: readonly LevelFourPin[] = [
  { id: 'arcane-eye', source: 'spell-descriptions.txt:398', targeting: { kind: 'utility', rangeFeet: 30 }, operation: { kind: 'utility', effect: { kind: 'arcane_eye', darkvisionFeet: 30, moveFeetPerBonusAction: 30, minimumOpeningInches: 1, invisible: true, invulnerable: true }, concentration: true, durationRounds: 600 } },
  ...
  { id: 'death-ward', source: 'spell-descriptions.txt:1992', targeting: { kind: 'single', rangeFeet: 5, willing: true }, operation: { kind: 'effect', effect: effect({ kind: 'death_ward', replacementHitPoints: 1, negatesInstantDeath: true, consumedOnTrigger: true }, { durationRounds: 4800 }) } },
  { id: 'dimension-door', source: 'spell-descriptions.txt:2156', targeting: { kind: 'utility', rangeFeet: 500 }, operation: { kind: 'utility', effect: { kind: 'dimension_door', maximumDistanceFeet: 500, maximumPassengers: 1, passengerStartFeet: 5, passengerDestinationFeet: 5, failureDamageCount: 4, failureDamageSides: 6, failureDamageType: 'Force' }, concentration: false, durationRounds: null } },
  { id: 'divination', source: 'spell-descriptions.txt:2313', targeting: { kind: 'utility', rangeFeet: 0 }, operation: { kind: 'utility', effect: { kind: 'divination', forecastDays: 7, noAnswerChancePerExtraCastingPercent: 25 }, concentration: false, durationRounds: null } },
  ...
  { id: 'greater-invisibility', source: 'spell-descriptions.txt:3898', targeting: { kind: 'single', rangeFeet: 5, willing: true }, operation: { kind: 'effect', effect: effect({ kind: 'condition', condition: 'Invisible' }, { concentration: true, durationRounds: 10 }) } },
  { id: 'guardian-of-faith', source: 'spell-descriptions.txt:3927', targeting: { kind: 'utility', rangeFeet: 30 }, operation: { kind: 'utility', effect: { kind: 'guardian_of_faith', size: 'Large', triggerRadiusFeet: 10, saveAbility: 'dexterity', damage: 20, damageType: 'Radiant', onSuccess: 'half', maximumTotalDamage: 60 }, concentration: false, durationRounds: 4800, stateful: true } },
  ...
  { id: 'resilient-sphere', source: 'spell-descriptions.txt:6513', targeting: { kind: 'single', rangeFeet: 30, willing: false }, operation: { kind: 'save_effect', ability: 'dexterity', rollMode: 'normal', effect: effect({ kind: 'resilient_sphere', maximumSize: 'Large', blocksPhysicalObjectsEnergyAndSpells: true, immuneToDamage: true, rollSpeedMultiplier: 0.5, destroyedBy: 'Disintegrate' }, { concentration: true, durationRounds: 10 }) } },
  { id: 'secret-chest', source: 'spell-descriptions.txt:6755', targeting: { kind: 'utility', rangeFeet: 5 }, operation: { kind: 'utility', effect: { kind: 'secret_chest', chestDimensionsFeet: [3, 2, 2], capacityCubicFeet: 12, recallDistanceFeet: 5, riskBeginsAfterDays: 60, dailyEndChancePercent: 5, chestMinimumGp: 5000, replicaMinimumGp: 50 }, concentration: false, durationRounds: null, stateful: true } },
  { id: 'stone-shape', source: 'spell-descriptions.txt:7413', targeting: { kind: 'utility', rangeFeet: 5 }, operation: { kind: 'utility', effect: { kind: 'stone_shape', maximumDimensionFeet: 5, maximumHinges: 2, permitsLatch: true }, concentration: false, durationRounds: null, stateful: true } },
  { id: 'stoneskin', source: 'spell-descriptions.txt:7429', targeting: { kind: 'single', rangeFeet: 5, willing: true }, operation: { kind: 'effect', effect: effect({ kind: 'damage_resistances', damageTypes: ['Bludgeoning', 'Piercing', 'Slashing'] }, { concentration: true, durationRounds: 600 }) } },
...
function castSpell(
  ...
  return reduceEncounter(state, {
    ...
    targets: selectsTarget ? [target.id] : [], area: spellArea(definition), weaponAttack: null, selectedOption: null,
  }, rng);
}
