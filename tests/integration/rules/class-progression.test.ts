...
describe('persisted class progression catalog', () => {
  ...
  it('persists base-class metadata with third-caster rules only on subclasses', () => {
    ...
    expect(
      ...
      { name: 'Arcane Trickster', class_name: 'Rogue', spellcasting_ability: 'intelligence', caster_fraction: '1/3', caster_rounding: 'down' },
      { name: 'Eldritch Knight', class_name: 'Fighter', spellcasting_ability: 'intelligence', caster_fraction: '1/3', caster_rounding: 'down' },
    ]);
  });
  ...
  it('persists all third-caster preparation and slot breakpoints', () => {
    expect(
      ...
      { name: 'Arcane Trickster', class_level: 3, prepared_count: 3, max_spell_level: 1, slots: { 1: 2 } },
      { name: 'Arcane Trickster', class_level: 7, prepared_count: 5, max_spell_level: 2, slots: { 1: 4, 2: 2 } },
      { name: 'Arcane Trickster', class_level: 13, prepared_count: 9, max_spell_level: 3, slots: { 1: 4, 2: 3, 3: 2 } },
      { name: 'Arcane Trickster', class_level: 19, prepared_count: 12, max_spell_level: 4, slots: { 1: 4, 2: 3, 3: 3, 4: 1 } },
      { name: 'Eldritch Knight', class_level: 3, prepared_count: 3, max_spell_level: 1, slots: { 1: 2 } },
      { name: 'Eldritch Knight', class_level: 7, prepared_count: 5, max_spell_level: 2, slots: { 1: 4, 2: 2 } },
      { name: 'Eldritch Knight', class_level: 13, prepared_count: 9, max_spell_level: 3, slots: { 1: 4, 2: 3, 3: 2 } },
      { name: 'Eldritch Knight', class_level: 19, prepared_count: 12, max_spell_level: 4, slots: { 1: 4, 2: 3, 3: 3, 4: 1 } },
    ]);
  });
