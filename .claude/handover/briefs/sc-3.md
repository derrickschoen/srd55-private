...
2. **You still build exactly the additive-14 shape**, because the replacement
   is unapproved and unwritten: twelve SRD definitions added, EK
   and AT retained with all **40** progression rows. Your
...
| Both dense schedules survive | `delete-at-rows` | **"persists all third-caster preparation and slot breakpoints"** |
